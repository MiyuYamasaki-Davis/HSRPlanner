                    ...
                    <tbody>
                        <tr className='w-full border'>
                            ...
                            <td className='border p-4 flex items-center justify-center'>
                                ...
                                <input type="number" min='0' value={bBookMat} onChange={(event) => setBBookMat(event.target.value)} className='w-12 justify-center text-center border-2'/>
                            </td>
                            <td/>
                            <td className='border p-4 flex items-center justify-center'>
                                <Image src={pBook} alt="pBook" className='object-center w-16 h-auto'/>
                                <input type="number" min='0' value={pBookMat} onChange={(event) => setPBookMat(event.target.value)} className='w-12 justify-center text-center border-2'/>
                            </td>
                        </tr>
                        <tr className='w-full border'>
                            <th className='p-5 justify-center items-center bg-dark text-light'>
                            ...
                            <td className='border p-4 flex items-center justify-center'>
                                ...
                                <input type="number" min='0' value={gFilmMat} onChange={(event) => setGFilmMat(event.target.value)} className='w-12 justify-center text-center border-2'/>
                            </td>
                            <td/>
                            <td className='border p-4 flex items-center justify-center'>
                                <Image src={bFilm} alt="pBook" className='object-center w-16 h-auto'/>
                                <input type="number" min='0' value={bFilmMat} onChange={(event) => setBFilmMat(event.target.value)} className='w-12 justify-center text-center border-2'/>
                            </td>
                            <td/>
                            <td className='border p-4 flex items-center justify-center'>
                                <Image src={pFilm} alt="pBook" className='object-center w-16 h-auto'/>
                                <input type="number" min='0' value={pFilmMat} onChange={(event) => setPFilmMat(event.target.value)} className='w-12 justify-center text-center border-2'/>
                            </td>
                        </tr>
                    </tbody>
                </table>
                    ...
                    <tbody>
                        <tr className='w-full border'>
                            <td className='border p-4 flex items-center justify-center'>
                                ...
                                Shape of Abomination: <input type="number" min='0' value={stag10Mat} onChange={(event) => setStag10Mat(event.target.value)} className='w-12 justify-center text-center border-2'/>
                            </td>
                            <td/>
                            <td className='border p-4 flex items-center justify-center'>
                                <Image src={stag5} alt="pBook" className='object-center w-16 h-auto'/>
                                Shape of Blaze: <input type="number" min='0' value={stag5Mat} onChange={(event) => setStag5Mat(event.target.value)} className='w-12 justify-center text-center border-2'/>
                            </td>
                            <td/>
                            <td className='border p-4 flex items-center justify-center'>
                                <Image src={stag1} alt="pBook" className='object-center w-16 h-auto'/>
                                Shape of Celestial: <input type="number" min='0' value={stag1Mat} onChange={(event) => setStag1Mat(event.target.value)} className='w-12 justify-center text-center border-2'/>
                            </td>
                            <td/>
                            <td className='border p-4 flex items-center justify-center'>
                                <Image src={stag13} alt="pBook" className='object-center w-16 h-auto'/>
                                Shape of Doom: <input type="number" min='0' value={stag13Mat} onChange={(event) => setStag13Mat(event.target.value)} className='w-12 justify-center text-center border-2'/>
                            </td>
                            <td/>
                            <td className='border p-4 flex items-center justify-center'>
                                <Image src={stag9} alt="pBook" className='object-center w-16 h-auto'/>
                                Shape of Fulmination: <input type="number" min='0' value={stag9Mat} onChange={(event) => setStag9Mat(event.target.value)} className='w-12 justify-center text-center border-2'/>
                            </td>
                            <td/>
                            <td className='border p-4 flex items-center justify-center'>
                                <Image src={stag14} alt="pBook" className='object-center w-16 h-auto'/>
                                Shape of Gust: <input type="number" min='0' value={stag14Mat} onChange={(event) => setStag14Mat(event.target.value)} className='w-12 justify-center text-center border-2'/>
                            </td>
                            <td/>
                            <td className='border p-4 flex items-center justify-center'>
                                <Image src={stag6} alt="pBook" className='object-center w-16 h-auto'/>
                                Shape of Icicle: <input type="number" min='0' value={stag6Mat} onChange={(event) => setStag6Mat(event.target.value)} className='w-12 justify-center text-center border-2'/>
                            </td>
                            <td/>
                            <td className='border p-4 flex items-center justify-center'>
                                <Image src={stag7} alt="pBook" className='object-center w-16 h-auto'/>
                                Shape of Mirage: <input type="number" min='0' value={stag7Mat} onChange={(event) => setStag7Mat(event.target.value)} className='w-12 justify-center text-center border-2'/>
                            </td>
                        </tr>
                        <tr className='w-full border'>
                            <td className='border p-4 flex items-center justify-center'>
                                <Image src={stag4} alt="pBook" className='object-center w-16 h-auto'/>
                                Shape of Nectar: <input type="number" min='0' value={stag4Mat} onChange={(event) => setStag4Mat(event.target.value)} className='w-12 justify-center text-center border-2'/>
                            </td>
                            <td/>
                            <td className='border p-4 flex items-center justify-center'>
                                <Image src={stag11} alt="pBook" className='object-center w-16 h-auto'/>
                                Shape of Perdition: <input type="number" min='0' value={stag11Mat} onChange={(event) => setStag11Mat(event.target.value)} className='w-12 justify-center text-center border-2'/>
                            </td>
                            <td/>
                            <td className='border p-4 flex items-center justify-center'>
                                <Image src={stag15} alt="pBook" className='object-center w-16 h-auto'/>
                                Shape of Puppetry: <input type="number" min='0' value={stag15Mat} onChange={(event) => setStag15Mat(event.target.value)} className='w-12 justify-center text-center border-2'/>
                            </td>
                            <td/>
                            <td className='border p-4 flex items-center justify-center'>
                                <Image src={stag16} alt="pBook" className='object-center w-16 h-auto'/>
                                Shape of Quanta: <input type="number" min='0' value={stag16Mat} onChange={(event) => setStag16Mat(event.target.value)} className='w-12 justify-center text-center border-2'/>
                            </td>
                            <td/>
                            <td className='border p-4 flex items-center justify-center'>
                                <Image src={stag8} alt="pBook" className='object-center w-16 h-auto'/>
                                Shape of Rime: <input type="number" min='0' value={stag8Mat} onChange={(event) => setStag8Mat(event.target.value)} className='w-12 justify-center text-center border-2'/>
                            </td>
                            <td/>
                            <td className='border p-4 flex items-center justify-center'>
                                <Image src={stag3} alt="pBook" className='object-center w-16 h-auto'/>
                                Shape of Roast: <input type="number" min='0' value={stag3Mat} onChange={(event) => setStag3Mat(event.target.value)} className='w-12 justify-center text-center border-2'/>
                            </td>
                            <td/>
                            <td className='border p-4 flex items-center justify-center'>
                                <Image src={stag12} alt="pBook" className='object-center w-16 h-auto'/>
                                Shape of Scorch: <input type="number" min='0' value={stag12Mat} onChange={(event) => setStag12Mat(event.target.value)} className='w-12 justify-center text-center border-2'/>
                            </td>
                            <td/>
                            <td className='border p-4 flex items-center justify-center'>
                                <Image src={stag2} alt="pBook" className='object-center w-16 h-auto'/>
                                Shape of Spike: <input type="number" min='0' value={stag2Mat} onChange={(event) => setStag2Mat(event.target.value)} className='w-12 justify-center text-center border-2'/>
                            </td>
                        </tr>
                        <tr className='w-full border'>
                            <td className='border p-4 flex items-center justify-center'>
                                <Image src={stag17} alt="pBook" className='object-center w-16 h-auto'/>
                                Shape of Ire: <input type="number" min='0' value={stag17Mat} onChange={(event) => setStag17Mat(event.target.value)} className='w-12 justify-center text-center border-2'/>
                            </td>
                            <td/>
                            <td/>
                            <td/>
                    ...
                    <tbody>
                        <tr className='w-full border'>
                            <td className='border p-4 flex items-center justify-center'>
                                ...
                                Destroyer: <input type="number" min='0' value={DMat} onChange={(event) => setDMat(event.target.value)} className='w-12 justify-center text-center border-2'/>
                            </td>
                            <td/>
                            <td className='border p-4 flex items-center justify-center'>
                                <Image src={eternal} alt="pBook" className='object-center w-16 h-auto'/>
                                Eternal Freeze: <input type="number" min='0' value={EFMat} onChange={(event) => setEFMat(event.target.value)} className='w-12 justify-center text-center border-2'/>
                            </td>
                            <td/>
                            <td className='border p-4 flex items-center justify-center'>
                                <Image src={divineseed} alt="pBook" className='object-center w-16 h-auto'/>
                                Divine Seed: <input type="number" min='0' value={DSMat} onChange={(event) => setDSMat(event.target.value)} className='w-12 justify-center text-center border-2'/>
                            </td>
                            <td/>
                            <td className='border p-4 flex items-center justify-center'>
                                <Image src={borehole} alt="pBook" className='object-center w-16 h-auto'/>
                                Borehole: <input type="number" min='0' value={BMat} onChange={(event) => setBMat(event.target.value)} className='w-12 justify-center text-center border-2'/>
                            </td>
                        </tr>
                    </tbody>
                </table>
                    ...
                    <tbody>
                        <tr className='w-full border'>
                            ...
                            <td className='border p-4 flex items-center justify-center'>
                                ...
                                <input type="number" min='0' value={gABPMat} onChange={(event) => setgABPMat(event.target.value)} className='w-12 justify-center text-center border-2'/>
                            </td>
                            <td/>
                            <td className='border p-4 flex items-center justify-center'>
                                <Image src={bABP} alt="pBook" className='object-center w-16 h-auto'/>
                                <input type="number" min='0' value={bABPMat} onChange={(event) => setbABPMat(event.target.value)} className='w-12 justify-center text-center border-2'/>
                            </td>
                            <td/>
                            <td className='border p-4 flex items-center justify-center'>
                                <Image src={pABP} alt="pBook" className='object-center w-16 h-auto'/>
                                <input type="number" min='0' value={pABPMat} onChange={(event) => setpABPMat(event.target.value)} className='w-12 justify-center text-center border-2'/>
                            </td>
                        </tr>
                        <tr className='w-full border'>
                            <th className='p-5 justify-center items-center bg-dark text-light'>
                            ...
                            <td className='border p-4 flex items-center justify-center'>
                                ...
                                <input type="number" min='0' value={gAFGMat} onChange={(event) => setgAFGMat(event.target.value)} className='w-12 justify-center text-center border-2'/>
                            </td>
                            <td/>
                            <td className='border p-4 flex items-center justify-center'>
                                <Image src={bAFG} alt="pBook" className='object-center w-16 h-auto'/>
                                <input type="number" min='0' value={bAFGMat} onChange={(event) => setbAFGMat(event.target.value)} className='w-12 justify-center text-center border-2'/>
                            </td>
                            <td/>
                            <td className='border p-4 flex items-center justify-center'>
                                <Image src={pAFG} alt="pBook" className='object-center w-16 h-auto'/>
                                <input type="number" min='0' value={pAFGMat} onChange={(event) => setpAFGMat(event.target.value)} className='w-12 justify-center text-center border-2'/>
                            </td>
                        </tr>
                        <tr className='w-full border'>
                            <th className='p-5 justify-center items-center bg-dark text-light'>
                            ...
                            <td className='border p-4 flex items-center justify-center'>
                                ...
                                <input type="number" min='0' value={gDSWMat} onChange={(event) => setgDSWMat(event.target.value)} className='w-12 justify-center text-center border-2'/>
                            </td>
                            <td/>
                            <td className='border p-4 flex items-center justify-center'>
                                <Image src={bDSW} alt="pBook" className='object-center w-16 h-auto'/>
                                <input type="number" min='0' value={bDSWMat} onChange={(event) => setbDSWMat(event.target.value)} className='w-12 justify-center text-center border-2'/>
                            </td>
                            <td/>
                            <td className='border p-4 flex items-center justify-center'>
                                <Image src={pDSW} alt="pBook" className='object-center w-16 h-auto'/>
                                <input type="number" min='0' value={pDSWMat} onChange={(event) => setpDSWMat(event.target.value)} className='w-12 justify-center text-center border-2'/>
                            </td>
                        </tr>
                        <tr className='w-full border'>
                            <th className='p-5 justify-center items-center bg-dark text-light'>
                            ...
                            <td className='border p-4 flex items-center justify-center'>
                                ...
                                <input type="number" min='0' value={gDSZMat} onChange={(event) => setgDSZMat(event.target.value)} className='w-12 justify-center text-center border-2'/>
                            </td>
                            <td/>
                            <td className='border p-4 flex items-center justify-center'>
                                <Image src={bDSZ} alt="pBook" className='object-center w-16 h-auto'/>
                                <input type="number" min='0' value={bDSZMat} onChange={(event) => setbDSZMat(event.target.value)} className='w-12 justify-center text-center border-2'/>
                            </td>
                            <td/>
                            <td className='border p-4 flex items-center justify-center'>
                                <Image src={pDSZ} alt="pBook" className='object-center w-16 h-auto'/>
                                <input type="number" min='0' value={pDSZMat} onChange={(event) => setpDSZMat(event.target.value)} className='w-12 justify-center text-center border-2'/>
                            </td>
                        </tr>
                        <tr className='w-full border'>
                            <th className='p-5 justify-center items-center bg-dark text-light'>
                            ...
                            <td className='border p-4 flex items-center justify-center'>
                                ...
                                <input type="number" min='0' value={gEMat} onChange={(event) => setgEMat(event.target.value)} className='w-12 justify-center text-center border-2'/>
                            </td>
                            <td/>
                            <td className='border p-4 flex items-center justify-center'>
                                <Image src={bE} alt="pBook" className='object-center w-16 h-auto'/>
                                <input type="number" min='0' value={bEMat} onChange={(event) => setbEMat(event.target.value)} className='w-12 justify-center text-center border-2'/>
                            </td>
                            <td/>
                            <td className='border p-4 flex items-center justify-center'>
                                <Image src={pE} alt="pBook" className='object-center w-16 h-auto'/>
                                <input type="number" min='0' value={pEMat} onChange={(event) => setpEMat(event.target.value)} className='w-12 justify-center text-center border-2'/>
                            </td>
                        </tr>
                        <tr className='w-full border'>
                            <th className='p-5 justify-center items-center bg-dark text-light'>
                            ...
                            <td className='border p-4 flex items-center justify-center'>
                                ...
                                <input type="number" min='0' value={gHRSMat} onChange={(event) => setgHRSMat(event.target.value)} className='w-12 justify-center text-center border-2'/>
                            </td>
                            <td/>
                            <td className='border p-4 flex items-center justify-center'>
                                <Image src={bHRS} alt="pBook" className='object-center w-16 h-auto'/>
                                <input type="number" min='0' value={bHRSMat} onChange={(event) => setbHRSMat(event.target.value)} className='w-12 justify-center text-center border-2'/>
                            </td>
                            <td/>
                            <td className='border p-4 flex items-center justify-center'>
                                <Image src={pHRS} alt="pBook" className='object-center w-16 h-auto'/>
                                <input type="number" min='0' value={pHRSMat} onChange={(event) => setpHRSMat(event.target.value)} className='w-12 justify-center text-center border-2'/>
                            </td>
                        </tr>
                        <tr className='w-full border'>
                            <th className='p-5 justify-center items-center bg-dark text-light'>
                            ...
                            <td className='border p-4 flex items-center justify-center'>
                                ...
                                <input type="number" min='0' value={gHTRMat} onChange={(event) => setgHTRMat(event.target.value)} className='w-12 justify-center text-center border-2'/>
                            </td>
                            <td/>
                            <td className='border p-4 flex items-center justify-center'>
                                <Image src={bHTR} alt="pBook" className='object-center w-16 h-auto'/>
                                <input type="number" min='0' value={bHTRMat} onChange={(event) => setbHTRMat(event.target.value)} className='w-12 justify-center text-center border-2'/>
                            </td>
                            <td/>
                            <td className='border p-4 flex items-center justify-center'>
                                <Image src={pHTR} alt="pBook" className='object-center w-16 h-auto'/>
                                <input type="number" min='0' value={pHTRMat} onChange={(event) => setpHTRMat(event.target.value)} className='w-12 justify-center text-center border-2'/>
                            </td>
                        </tr>
                        <tr className='w-full border'>
                            <th className='p-5 justify-center items-center bg-dark text-light'>
                            ...
                            <td className='border p-4 flex items-center justify-center'>
                                ...
                                <input type="number" min='0' value={gNACMat} onChange={(event) => setgNACMat(event.target.value)} className='w-12 justify-center text-center border-2'/>
                            </td>
                            <td/>
                            <td className='border p-4 flex items-center justify-center'>
                                <Image src={bNAC} alt="pBook" className='object-center w-16 h-auto'/>
                                <input type="number" min='0' value={bNACMat} onChange={(event) => setbNACMat(event.target.value)} className='w-12 justify-center text-center border-2'/>
                            </td>
                            <td/>
                            <td className='border p-4 flex items-center justify-center'>
                                <Image src={pNAC} alt="pBook" className='object-center w-16 h-auto'/>
                                <input type="number" min='0' value={pNACMat} onChange={(event) => setpNACMat(event.target.value)} className='w-12 justify-center text-center border-2'/>
                            </td>
                        </tr>
                        <tr className='w-full border'>
                            <th className='p-5 justify-center items-center bg-dark text-light'>
                            ...
                            <td className='border p-4 flex items-center justify-center'>
                                ...
                                <input type="number" min='0' value={gNGMMat} onChange={(event) => setgNGMMat(event.target.value)} className='w-12 justify-center text-center border-2'/>
                            </td>
                            <td/>
                            <td className='border p-4 flex items-center justify-center'>
                                <Image src={bNGM} alt="pBook" className='object-center w-16 h-auto'/>
                                <input type="number" min='0' value={bNGMMat} onChange={(event) => setbNGMMat(event.target.value)} className='w-12 justify-center text-center border-2'/>
                            </td>
                            <td/>
                            <td className='border p-4 flex items-center justify-center'>
                                <Image src={pNGM} alt="pBook" className='object-center w-16 h-auto'/>
                                <input type="number" min='0' value={pNGMMat} onChange={(event) => setpNGMMat(event.target.value)} className='w-12 justify-center text-center border-2'/>
                            </td>
                        </tr>
                        <tr className='w-full border'>
                            <th className='p-5 justify-center items-center bg-dark text-light'>
                            ...
                            <td className='border p-4 flex items-center justify-center'>
                                ...
                                <input type="number" min='0' value={gPSZMat} onChange={(event) => setgPSZMat(event.target.value)} className='w-12 justify-center text-center border-2'/>
                            </td>
                            <td/>
                            <td className='border p-4 flex items-center justify-center'>
                                <Image src={bPSZ} alt="pBook" className='object-center w-16 h-auto'/>
                                <input type="number" min='0' value={bPSZMat} onChange={(event) => setbPSZMat(event.target.value)} className='w-12 justify-center text-center border-2'/>
                            </td>
                            <td/>
                            <td className='border p-4 flex items-center justify-center'>
                                <Image src={pPSZ} alt="pBook" className='object-center w-16 h-auto'/>
                                <input type="number" min='0' value={pPSZMat} onChange={(event) => setpPSZMat(event.target.value)} className='w-12 justify-center text-center border-2'/>
                            </td>
                        </tr>
                        <tr className='w-full border'>
                            <th className='p-5 justify-center items-center bg-dark text-light'>
                            ...
                            <td className='border p-4 flex items-center justify-center'>
                                ...
                                <input type="number" min='0' value={gPCSTPMat} onChange={(event) => setgPCSTPMat(event.target.value)} className='w-12 justify-center text-center border-2'/>
                            </td>
                            <td/>
                            <td className='border p-4 flex items-center justify-center'>
                                <Image src={bPCSTP} alt="pBook" className='object-center w-16 h-auto'/>
                                <input type="number" min='0' value={bPCSTPMat} onChange={(event) => setbPCSTPMat(event.target.value)} className='w-12 justify-center text-center border-2'/>
                            </td>
                            <td/>
                            <td className='border p-4 flex items-center justify-center'>
                                <Image src={pPCSTP} alt="pBook" className='object-center w-16 h-auto'/>
                                <input type="number" min='0' value={pPCSTPMat} onChange={(event) => setpPCSTPMat(event.target.value)} className='w-12 justify-center text-center border-2'/>
                            </td>
                        </tr>
                        <tr className='w-full border'>
                            <th className='p-5 justify-center items-center bg-dark text-light'>
                            ...
                            <td className='border p-4 flex items-center justify-center'>
                                ...
                                <input type="number" min='0' value={gHMat} onChange={(event) => setgHMat(event.target.value)} className='w-12 justify-center text-center border-2'/>
                            </td>
                            <td/>
                            <td className='border p-4 flex items-center justify-center'>
                                <Image src={bH} alt="pBook" className='object-center w-16 h-auto'/>
                                <input type="number" min='0' value={bHMat} onChange={(event) => setbHMat(event.target.value)} className='w-12 justify-center text-center border-2'/>
                            </td>
                            <td/>
                            <td className='border p-4 flex items-center justify-center'>
                                <Image src={pH} alt="pBook" className='object-center w-16 h-auto'/>
                                <input type="number" min='0' value={pHMat} onChange={(event) => setpHMat(event.target.value)} className='w-12 justify-center text-center border-2'/>
                            </td>
                        </tr>
                    </tbody>
                </table>
